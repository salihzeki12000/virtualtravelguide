...
{
  extract($_POST);
 $shop->updateStatus($prid,$upd_status);
                ...
                <div class="row">
                  <div class="card col-md-12" >
                    ...
                    <div class="fresh-table">
                      <div class="toolbar">
                      <a href="shop.php?sidebar=shop"><button class="btn btn-success">Shop</button></a>
                        <a href="uservendor.php?sidebar=product"><button class="btn btn-success">My Products</button></a>
                    ...
                    {
                      ?>
                    <a href="userproductdetails.php?sidebar=product"><button class="btn btn-warning">All Products</button></a>
                        <?php } ?>
                      ...
                      <table  id="fresh-table" class="table table-bordered" style="text-align:center;" >
                          <thead>
                            <tr>
                              ...
                              <th data-field="cname" data-sortable="true"> Customer Name</th>
                              <th data-field="pname" data-sortable="true"> Product Name</th>
                              <th data-field="receivedate" data-sortable="true"> Received Date</th>
                          ...
                          <tbody>
                              ...
                              <?php   $product=$shop->getAllVendorUser();
                         ...
                         $id=$pvalue['id'];
                              ...
                              <td><?php $shop->cname($cid); ?></td>

                             <td><?php $shop->pname($pids);  ?></td>
                              ...
                              <?php $shop->cdet($cid); ?>
                               ...
                               <td><?php echo $pvalue['prquantity'] ?></td>
                                ...
                                <td><?php $status=$pvalue['pr_orderstatus'];
                                ...
                                switch($status)
                                {
                                  ...
                                  case '3':
                                  {
                                    echo "<kbd class='btn btn-xs btn-info'>Customer Confirmed</kbd>";
                                    break;
                                  }
                                  case '4':
                                  {
                                ...
                                <td>
                                  ...
                                  <form action=" " method="POST">
                                    ...
                                    <input type="hidden" name="action" value="product_order">

                                    <select class="form-control" name="upd_status" >
                                      <option value="0">Customer Cancelled</option>
                                      <option value="2">Confirmation Pending</option>
                                      <option value="1">Transaction Complete</option>
                                      <option value="3">Customer Confirmed</option>
