...
{
  extract($_GET);
@$hotel->publishhotel($hid,$hstatus);
}
?>
<div class="wrapper">
        ...
        <div class="row">
          <div class="card col-md-12" >
            ...
            <div class="fresh-table">
              ...
              <table  id="fresh-table" class="table table-bordered"  >
                <thead>
                  <tr>
                    ...
                    <th data-field="added on" data-sortable="true"> Joined On</th>
             ...
             <tr>
                        <?php
                        $hotelv=$hotel->getAllHotel();
                        foreach($hotelv as $key => $hotelvalue)
                        {
                          $hid=$hotelvalue['id'];
                            $hstatus=$hotelvalue['status'];

                          ?>
                          <td><?php echo $hid; ?></td>
                           <td style=" text-transform: uppercase;"><a href="single.php?hid=<?php echo $hid;?>"><?php echo $hotelvalue['company_name']; ?></td>
                            <td><?php echo $hotelvalue['username']; ?></td>
                             <td><?php echo $hotelvalue['email']; ?></td>
                              <td><?php echo $hotelvalue['address']; ?></td>
                               <td><?php echo $hotelvalue['location']; ?></td>
                               <td><?php echo $hotelvalue['contact']; ?></td>
                             <td><?php echo substr($hotelvalue['description'],0,45); ?>......</td>

                             <td><?php echo $hotelvalue['joindate']; ?></td>
                              <td><?php echo $hotelvalue['latitude']; ?></td>
                               <td><?php echo $hotelvalue['longitude']; ?></td>
                          <td>
                            <form action=" " method="GET">
                            <input type="hidden" name="hid" value="<?php echo $hid;?>">
                            <input type="hidden" name="hstatus" value="<?php echo $hstatus;?>">
                           ...
                           ?>
                              ...
                              <td><img src="../<?php echo $hotelvalue['image']; ?>" alt="cover image" style="height:60px;width:60px;"></td>
<!--
                              <td><img src="../<?php //echo $hotelvalue['himage']; ?>" alt="hotel image" style="height:60px;width:60px;"></td> -->




                               <td>
                            <!-- <a href='edit.php?action=edit&hid=<?php //echo $hid;?>&of=hotel&sidebar=hotel'> <button type='button' rel='tooltip' title='Edit hotel' class='btn btn-success btn-simple btn-xs'><i class='fa fa-edit'></i></button></a> -->
                            <a href='delete.php?action=delete&id=<?php echo $hid;?>&of=hotel'><button type='button' rel='tooltip' title='Delete hotel' class='btn btn-danger btn-simple btn-xs' id='delbutton'>
