...
--
-- Host: 127.0.0.1
-- Generation Time: Sep 04, 2018 at 05:31 PM
...
(8, 'Scooter', 'motorcycle', '', 2, 1000, '2018-09-01 07:50:21', 1, '', 'images/vehicle/01-09-2018-153578102139517_HondaGrazia-2018006.JPG', '', 57, 1);
...
--
ALTER TABLE `book_package`
  MODIFY `pbid` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=27;

--
-- AUTO_INCREMENT for table `book_vehicle`
--
ALTER TABLE `book_vehicle`
  MODIFY `vbid` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=19;
