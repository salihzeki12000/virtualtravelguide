...
--
-- Host: 127.0.0.1
-- Generation Time: May 24, 2018 at 06:17 AM
...
(39, 'Samrat Homestay', 'htlsamrat', 'Gathaghar', 'Bhaktapur', '615865556', NULL, 'samrat@gmail.com', '', NULL, 'images/hotels/hotel/23-05-2018-1527091631homestay-nepal-alice-mcconnell.jpg', '', '', 1, 2, '');
...
(2, 'Mardi Base Camp Trek ', 'Pokhara , Mardi himal, Nepal', 'Pokhara', 'Situated just east of the Annapurna Base Camp trek, the Mardi Himal trek is a hidden gem, as few trekkers make their way to Mardi Himalâ€™s Base Camp, spectacularly situated at the base of Mardi Himal and the beautiful and imposing Machhapuchhere or Fishtail.', '15000', '', '', '', 'Trekking', 2, '', '', NULL, 1, 'sjonchhe ', '', '');
...
(1, 25, '', 101, 'Deluxe Room', '', 1, 0, 13000, 'images/hotels/room/deluxe-room-01.jpg', NULL, NULL, 1, 1, 1, 1, 1, 1, 2, 0, 1, 0, 2),
(6, 20, '', 101, 'Double Deluxe Room', '', 2, 0, 9000, 'images/hotels/room/room-12.jpg', NULL, NULL, 0, 1, 1, 0, 1, 1, 2, 1, 0, 0, 2),
(7, 39, '', 1, 'Kitchen Wala Room', '', 1, 1000, 0, '', NULL, NULL, 1, 1, 0, 0, 1, 0, 2, 0, 0, 0, 2);
...
--
ALTER TABLE `hotel`
  MODIFY `hid` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=40;
